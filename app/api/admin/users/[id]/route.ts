...
// PATCH: banir/desbanir, forçar desativação de assinatura, ou
// verificar/desverificar CREF.
export async function PATCH(
  ...
  try {
    ...
    console.error("[/api/admin/users/[id] PATCH] erro inesperado:", err);
    return NextResponse.json(
      {
...
export async function DELETE(
  ...
  try {
    ...
    console.error("[/api/admin/users/[id] DELETE] erro inesperado:", err);
    return NextResponse.json(
      {
        error: `Erro inesperado: ${err?.message ?? "confira as variáveis de ambiente na Vercel."}`,
      },
